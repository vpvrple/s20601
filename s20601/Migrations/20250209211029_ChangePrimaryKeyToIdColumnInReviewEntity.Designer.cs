...
namespace s20601.Migrations
{
    ...
    [Migration("20250209211029_ChangePrimaryKeyToIdColumnInReviewEntity")]
    partial class ChangePrimaryKeyToIdColumnInReviewEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("s20601.Data.Models.Permission", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("s20601.Data.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("s20601.Data.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GroupOwnership", b =>
                {
                    ...
                    b.HasOne("s20601.Data.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PermissionRole", b =>
                {
                    b.HasOne("s20601.Data.Models.Permission", null)
                        .WithMany()
                        .HasForeignKey("Permission_Id")
                        .IsRequired()
                        .HasConstraintName("PermissionRole_Permission");

                    b.HasOne("s20601.Data.Models.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("s20601.Data.Models.Message", b =>
                {
                    b.HasOne("s20601.Data.Models.User", "IdRecipientNavigation")
                        .WithMany("MessageIdRecipientNavigations")
                        .HasForeignKey("IdRecipient")
                        .IsRequired()
                        .HasConstraintName("Message_Recipient");

                    b.HasOne("s20601.Data.Models.User", "IdSenderNavigation")
            ...
            modelBuilder.Entity("s20601.Data.Models.MovieCollectionUser", b =>
                {
                    ...
                    b.HasOne("s20601.Data.Models.Role", "IdRoleNavigation")
                        .WithMany("MovieCollectionUsers")
            ...
            modelBuilder.Entity("s20601.Data.Models.Review", b =>
                {
                    b.HasOne("s20601.Data.Models.User", "IdAuthorNavigation")
                        .WithOne("Review")
            ...
            modelBuilder.Entity("s20601.Data.Models.UserRelationship", b =>
                {
                    b.HasOne("s20601.Data.Models.User", "IdRelatedUserNavigation")
