...
namespace s20601.Migrations
{
    ...
    [Migration("20251122194813_NewInitialMigrationAfterAlignmentWithDb")]
    partial class NewInitialMigrationAfterAlignmentWithDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("s20601.Data.Models.AspNetRole", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("s20601.Data.Models.AspNetRoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("s20601.Data.Models.AspNetUserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("s20601.Data.Models.AspNetUserLogin", b =>
                {
            ...
            modelBuilder.Entity("s20601.Data.Models.AspNetUserToken", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("s20601.Data.Models.Comment", b =>
                {
                    ...
                    b.HasIndex(new[] { "IdComment" }, "IX_Comment_IdComment");

                    b.HasIndex(new[] { "IdPost" }, "IX_Comment_IdPost");

                    b.HasIndex(new[] { "IdUser" }, "IX_Comment_IdUser");
            ...
            modelBuilder.Entity("AspNetUserRole", b =>
                {
                    b.HasOne("s20601.Data.Models.AspNetRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("s20601.Data.Models.AspNetRoleClaim", b =>
                {
                    b.HasOne("s20601.Data.Models.AspNetRole", "Role")
            ...
            modelBuilder.Entity("s20601.Data.Models.AspNetUserClaim", b =>
                {
                    b.HasOne("s20601.Data.Models.ApplicationUser", "User")
